...
/**
 * swap_node_behind - This is used to swap a node of integers with the one behind it.
 * @list: This points to the integer in the head of a doubly-linked list.
 * @tail: This points to the tail in a doubly-linked list.
 * @shaker:This points to the swapping node in the cocktail shaker algo.
 */
void swap_node_behind(listint_t **list, listint_t **tail, listint_t **shaker)
...
/**
 * cocktail_sort_list - This sort an integer in a doubly-linked list
